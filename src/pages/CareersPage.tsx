              ...
              <form onSubmit={handleSubmit} className="space-y-5 sm:space-y-6">
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-3 sm:px-4 py-2.5 sm:py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-brand-primary text-sm sm:text-base ${errors.fullName ? 'border-red-500' : 'border-gray-300'
                      }`}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5 sm:gap-6">
                  <div>
                    ...
                    <select
                      ...
                      onChange={handleInputChange}
                      className={`w-full px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-brand-primary ${errors.position ? 'border-red-500' : 'border-gray-300'
                        }`}
                    >
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={handleInputChange}
                      className={`w-full px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-brand-primary ${errors.yearsExperience ? 'border-red-500' : 'border-gray-300'
                        }`}
                    >
