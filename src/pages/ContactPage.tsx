                ...
                <form onSubmit={handleSubmit} className="space-y-5 sm:space-y-6">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full px-3 sm:px-4 py-2.5 sm:py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-brand-primary text-sm sm:text-base ${errors.name ? 'border-red-500' : 'border-gray-300'
                        }`}
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <input
                        ...
                        onChange={handleChange}
                        className={`w-full px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-brand-primary ${errors.email ? 'border-red-500' : 'border-gray-300'
                          }`}
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={handleChange}
                        className={`w-full px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-brand-primary ${errors.phone ? 'border-red-500' : 'border-gray-300'
                          }`}
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={handleChange}
                      className={`w-full px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-brand-primary ${errors.service ? 'border-red-500' : 'border-gray-300'
                        }`}
                    >
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      onChange={handleChange}
                      rows={6}
                      className={`w-full px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-brand-primary resize-none ${errors.message ? 'border-red-500' : 'border-gray-300'
                        }`}
                  ...
                  <button
                    ...
                    className={`w-full bg-brand-primary text-white px-6 sm:px-8 py-3 sm:py-4 rounded-lg transition-all font-semibold text-base sm:text-lg shadow-lg flex items-center justify-center gap-2 ${isSubmitting ? 'opacity-70 cursor-not-allowed' : 'hover:bg-opacity-90'
                      }`}
                  >
