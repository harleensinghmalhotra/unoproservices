...
export default function HomePage({ onNavigate }: HomePageProps) {
  ...
  return (
    <div className="bg-white">
      ...
      {/* Hero Section */}
      <section className="relative h-[450px] sm:h-[550px] md:h-[650px] lg:h-[700px] flex items-center pb-16 sm:pb-0">
        <div
        ...
        {/* Booking banner */}
        <div className="absolute bottom-2 sm:bottom-auto sm:top-6 left-1/2 -translate-x-1/2 z-20 w-full px-4 sm:px-0 flex justify-center">
